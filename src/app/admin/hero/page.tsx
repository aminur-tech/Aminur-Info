...
export default function AdminHeroPage() {
    return <ResourceEditor title="Hero section" description="Control the first impression on your public portfolio." resource="hero" singleton fields={[
        ...
        { name: "primaryCtaUrl", label: "Primary CTA URL" }, { name: "secondaryCtaLabel", label: "Secondary CTA label" },
        { name: "secondaryCtaUrl", label: "Secondary CTA URL" }, { name: "availabilityBadge", label: "Availability badge" },
