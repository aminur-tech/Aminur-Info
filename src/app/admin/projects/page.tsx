...
export default function AdminProjectsPage() {
    return <ResourceEditor title="Projects" description="Publish the work that best represents your craft." resource="projects" fields={[
        ...
        { name: "clientName", label: "Client name" }, { name: "clientUrl", label: "Client URL", type: "url" }, { name: "technologies", label: "Technologies (items separated by colon)" }, { name: "category", label: "Category" },
