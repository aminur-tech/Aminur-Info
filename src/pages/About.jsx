          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 pt-4">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="px-10 py-4 bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-black uppercase tracking-widest text-xs rounded-full shadow-[0_10px_30px_rgba(16,185,129,0.2)] transition-all"
              >
                Download Portfolio
              </motion.button>
