    ...
    <section className="relative min-h-screen text-white flex items-center overflow-x-hidden overflow-y-hidden px-4 sm:px-6 lg:px-24">
      ...
      <div className="container mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-center z-10 pt-10 md:pt-20 lg:pt-0">
        ...
        >
          ...
          {/* Description */}
          <motion.p variants={fadeInUp} className="text-gray-400 max-w-lg mx-auto lg:mx-0 leading-relaxed text-base sm:text-lg italic border-l-0 lg:border-l-2 border-green-500/20 pl-0 lg:pl-6">
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-3 sm:gap-5 pt-4 items-center lg:items-start">
            <motion.a href="/MERN.pdf" download whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
              className="flex items-center justify-center gap-3 bg-green-600 hover:bg-green-500 text-[#020617] font-bold py-4 px-10 rounded-xl transition-all shadow-[0_10px_30px_rgba(34,197,94,0.3)] w-full sm:w-auto">
              Get Resume <FaDownload size={16} />
            </motion.a>

            <motion.a href="#contact" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
              className="border-2 border-green-500/30 hover:border-green-500 py-4 px-10 rounded-xl transition-all text-green-500 font-bold bg-green-500/5 backdrop-blur-sm w-full sm:w-auto text-center">
              Contact Me
            </motion.a>
          </motion.div>

          {/* Social Icons */}
          <motion.div variants={fadeInUp} className="flex gap-5 sm:gap-8 text-xl sm:text-2xl text-gray-500 justify-center lg:justify-start">
            <a href="https://github.com/aminur-tech" className="hover:text-green-500 transition-all hover:-translate-y-1"><FaGithub /></a>
            <a href="https://www.linkedin.com/in/aminur-rahman4078" className="hover:text-green-500 transition-all hover:-translate-y-1"><FaLinkedin /></a>
            <a href="mailto:aminur.programme@gmail.com" className="hover:text-green-500 transition-all hover:-translate-y-1"><FaEnvelope /></a>
          </motion.div>
        </motion.div>
        ...
        {/* --- Right Side: Image --- */}
        <motion.div
          // FIX 3: Reduced initial x from 50 to 20 for mobile to prevent width overflow during entry
        ...
        >
          ...
          {/* FIX 4: Changed w-[110%] to w-full or w-[95%] to keep rings inside screen bounds */}
